...
modules/             46 modules (cart, products, orders, checkout, automations, comparisons, recommendations, multi-currency, faq, tickets, returns, store-credits, audit-log, etc.)
packages/
