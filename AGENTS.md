...
modules/             53 modules (cart, products, orders, checkout, backorders, preorders, affiliates, automations, comparisons, recommendations, multi-currency, faq, forms, tickets, customer-groups, quotes, product-qa, returns, store-credits, audit-log, etc.)
packages/
