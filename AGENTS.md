...
modules/             50 modules (cart, products, orders, checkout, affiliates, automations, comparisons, recommendations, multi-currency, faq, tickets, customer-groups, quotes, product-qa, returns, store-credits, audit-log, etc.)
packages/
