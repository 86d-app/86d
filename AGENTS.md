...
modules/             47 modules (cart, products, orders, checkout, automations, comparisons, recommendations, multi-currency, faq, tickets, customer-groups, returns, store-credits, audit-log, etc.)
packages/
