...
modules/             54 modules (cart, products, orders, checkout, backorders, preorders, affiliates, automations, comparisons, recommendations, multi-currency, faq, forms, tickets, customer-groups, quotes, product-qa, product-labels, returns, store-credits, audit-log, etc.)
packages/
