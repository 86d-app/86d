...
modules/             48 modules (cart, products, orders, checkout, affiliates, automations, comparisons, recommendations, multi-currency, faq, tickets, customer-groups, returns, store-credits, audit-log, etc.)
packages/
