...
modules/             51 modules (cart, products, orders, checkout, backorders, affiliates, automations, comparisons, recommendations, multi-currency, faq, tickets, customer-groups, quotes, product-qa, returns, store-credits, audit-log, etc.)
packages/
