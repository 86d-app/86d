...
modules/             49 modules (cart, products, orders, checkout, affiliates, automations, comparisons, recommendations, multi-currency, faq, tickets, customer-groups, quotes, returns, store-credits, audit-log, etc.)
packages/
