/**
 * Meta Graph API provider for Facebook Commerce.
 * Makes real HTTP calls to https://graph.facebook.com/.
 * Authentication uses a long-lived page access token.
 */
...
export interface MetaCommerceProviderConfig {
	accessToken: string;
	catalogId: string;
	commerceAccountId: string;
}

export class MetaCommerceProvider {
	private readonly accessToken: string;
	private readonly catalogId: string;
	private readonly commerceAccountId: string;

	constructor(config: MetaCommerceProviderConfig) {
