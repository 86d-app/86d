...
function FormFieldRenderer({ field, value, onChange }) {
  ...
  const commonClass = "w-full rounded-md border border-gray-300 bg-transparent px-3 py-2 text-sm transition-colors focus:border-gray-500 focus:outline-none dark:border-gray-700 dark:focus:border-gray-500";
