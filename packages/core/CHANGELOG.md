...
- [`b3c8feb`](https://github.com/86d-app/86d/commit/b3c8feb924c371a20b652313181166a61196acb5) Thanks [@imsanchez](https://github.com/imsanchez)! - Harden the public Command authority contracts with exact Change Set proposals, one-use approvals and confirmations, scoped standing permissions, normalized grant-use records, and versioned domain-separated hashes.
